...
\begin{frame}
\frametitle{Comparison Closure: $\BTags\ge3, 4\le\NJets\le6$ }
\begin{columns}
\centering
...
\begin{frame}
\frametitle{Comparison Closure: $\BTags\ge3, 7\le\NJets\le8$ }
\begin{columns}
\centering
           \begin{column}{0.50\textwidth}
     \begin{tikzpicture}
...
\begin{frame}
\frametitle{Comparison Closure: $\BTags\ge3, \NJets\ge9$ }
\begin{columns}
\centering
           \begin{column}{0.50\textwidth}
     \begin{tikzpicture}
...
\begin{frame}
 ...
 \begin{columns}
  ...
  \begin{itemize}
   ...
   \item Move back to $\Delta\phi (\MHT,j_{1,2,3})$ cut will help
  \end{itemize}
  \end{column}
  \begin{column}{0.33\textwidth}
   \begin{tikzpicture}
...
%  \frametitle{Adding back in $\tau\rightarrow\mu$ events}
 \begin{columns}
  \begin{column}{0.33\textwidth}
  \begin{itemize}
%   \item Including $\Delta\phi (\MHT,j_{1,2,3})$ cut
\item Including now also $\tau\rightarrow\mu$ decays in the $\mu$ conrol-sample
   \item Correcting for $\tau\rightarrow\mu$ as a function of make\HT, \MHT \& \NJets
   \item Gives reasonable closure
  \end{itemize}
  \end{column}
  \begin{column}{0.33\textwidth}
   \begin{tikzpicture}
