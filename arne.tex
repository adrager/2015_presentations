...
\centering
      \begin{overpic}[width=0.90\textwidth]{figures/efficiencies/MuAccHTNJets.pdf} 
     \end{overpic}
\end{frame}
...
\begin{frame}
 \frametitle{$\mu$ di lep contribution used parametization and binnning}
\centering
      \begin{overpic}[width=1.00\textwidth]{figures/efficiencies/MuDiLepContributionNJets1D.pdf} 
     \end{overpic}
\end{frame}
...
\centering
      \begin{overpic}[width=0.90\textwidth]{figures/efficiencies/ElecAccHTNJets.pdf} 
     \end{overpic}
\end{frame}
...
\begin{frame}
 \begin{itemize}
 \item Problem with parametrization following either \NJets or \BTags search bin definition can be solved by using more lepton relevant based variables
