...
\frametitle{\deltaphi vs \mindeltaphi}
  \begin{columns}
    \begin{column}{0.5\textwidth}
     \centering
      \begin{overpic}[width=0.70\textwidth]{figures/Closure_Old_Parametrization/Closure__HT__MuPrMTWDiLep_vs_MCEx__Baseline.pdf}\put(100,60){\rotatebox{-90}{\scriptsize \deltaphi cut}}
     \end{overpic}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \begin{overpic}[width=0.70\textwidth]{figures/Closure_New_Parametrization/Closure__HT__MuPrMTWDiLep_vs_MCEx__Baseline.pdf} \put(100,60){\rotatebox{-90}{\scriptsize \mindeltaphi cut}}     \end{overpic}
      \centering
