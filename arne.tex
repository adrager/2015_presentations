...
\begin{frame}
\frametitle{Classical Lost-Lepton Prediction of Lost Isolated $e,\mu$ events}
 \begin{center}
\begin{tikzpicture}
...
\end{tikzpicture}
 ...
 \begin{column}{0.50\textwidth}
  ...
  \end{itemize}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=1.\textwidth]{figures/lost-lepton_classic/Closure/Baseline/Closure__Bin__MCEx_vs_MuPrMTWDiLepIsoTrackReduced+ElecPrMTWDiLepIsoTrackReduced__Baseline.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}
 \end{column}
...
\begin{frame}
 \frametitle{Closure Tests Using Gen Information}
 \begin{center}
  
 \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.47\textwidth]{figures/lost-lepton_classic/Baseline_Truth/Closure__Bin__MCExIsoTrack_vs_MuPrMTWDiLepIsoTrackReduction+ElecPrMTWDiLepIsoTrackReduction__Baseline_Truth.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}
 \end{center}
...
\begin{itemize}
 \item Applying the correction factor on truth events (study correction w/o lost-lepton method) 
 \item Efficiencies are binned in \BTags \& \NJets (under study)
\end{itemize}
\end{frame}
...
\begin{frame}
 \frametitle{Veto of Additional Tracks in CS selection}
 \begin{columns}
 \begin{column}{0.50\textwidth}
 \begin{center}
 \begin{itemize}
 ...
 \end{itemize}
  ...
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=.65\textwidth]{figures/lost-lepton_classic/CS_VS_Expectation/Baseline/CS_VS_Expectation__Bin__MCExTotal_vs_MCMuCS+MCElecCS__Baseline.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}
 \end{center}
 ...
 \begin{center}
  \begin{itemize}
  \item With track Veto
 \end{itemize}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=.65\textwidth]{figures/lost-lepton_classic/CS_VS_Expectation_TrackRejection/Baseline/CS_VS_Expectation_TrackRejection__Bin__MCExTotal_vs_MCMuCS+MCElecCS__Baseline.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}
 \end{center}
...
\begin{frame}
 \frametitle{Iso Track Efficiencies}
\begin{columns}
 \begin{column}{0.50\textwidth}
 \begin{itemize}
  \item w/o iso track veto
...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=.7\textwidth]{figures/efficiencies/ttbar-wpj/IsoTrackReductionBTagNJets.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}\\
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=.7\textwidth]{figures/efficiencies/ttbar-wpj/ElecIsoTrackReductionBTagNJets.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}
 \end{column}
 ...
 \end{itemize}
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=.7\textwidth]{figures/efficiencies/ttbar-wpj/MuIsoTrackReductionBTagNJets.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}\\
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=.7\textwidth]{figures/efficiencies/ttbar-wpj/PionIsoTrackReductionBTagNJets.pdf}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \end{scope}
\end{tikzpicture}
 \end{column}
